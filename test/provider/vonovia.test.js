...
describe('#vonovia testsuite()', () => {
  let browser;

  beforeAll(async () => {
    browser = await launchBrowser(providerConfig.vonovia.url);
  }, TEST_TIMEOUT);
  ...
  it(
    ...
    async () => {
      ...
      provider.init(providerConfig.vonovia, [], []);
      ...
      notificationObj.payload.forEach((notify) => {
        ...
        expect(notify.link).toContain('https://www.vonovia.de/zuhause-finden/immobilien/');
