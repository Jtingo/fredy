...
class FredyPipelineExecutioner {
  ...
  /**
   * Geocode new listings. Listings whose provider already supplied exact
   * coordinates (e.g. from a portal API) are skipped: the provider's data is
   * more precise than a geocoder lookup and skipping saves rate-limited
   * Nominatim requests.
   *
